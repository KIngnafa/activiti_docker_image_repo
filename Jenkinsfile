        ...
        stage ('Configure DB Instance') {
            steps {
                sh '''
                    ...
                    docker exec activiti-cont sed -i "s/10.0.20.40/${SERVER_INSTANCE}/g" /usr/local/tomcat/webapps/activiti-app/WEB-INF/classes/META-INF/activiti-app/activiti-app.properties
